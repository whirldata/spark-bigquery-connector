...
public class GenericBigQuerySchemaHelper {
    ...
    public boolean isEnableBatchRead(ReadSessionCreatorConfig readSessionCreatorConfig, Optional<StructType> schema) {
        return readSessionCreatorConfig.getReadDataFormat() == DataFormat.ARROW && !isEmptySchema(schema);
    }
